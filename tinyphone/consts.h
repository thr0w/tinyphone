...
#define MSG_CONTACT_IT_SUPPORT "ERRO: Erro ao usar o som ou o microfone do computador"
#define MSG_DEVICE_ERROR "ERRO: Falha ao usar o som ou o microfone do computador"
